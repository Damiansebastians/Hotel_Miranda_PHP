...
<body>
    ...
    <div class="header__navbar">
      <div class="header__toggle">
        <div class="toggle__menu">
          <img class="toggle__menu__close" src="./img/close_menu_mobile.png" alt="Menu close">
          <img class="toggle__menu__open" src="./img/open_menu_mobile.png" alt="Menu open">
        </div>
        <ul class="menu__mobile" style="display: none;">
          <li class="menu__item"><a href="about.html">About Us</a></li>
          <li class="menu__item"><a href="rooms.html">Rooms</a></li>
          <li class="menu__item"><a href="offers.html">Offers</a></li>
          <li class="menu__item"><a href="contact.html">Contact</a></li>
        </ul>
      </div>
      <div class="header__logo"><a href="index.html"><img src="./img/logo_mobile.png" alt="Logo"></a></div>
      <div class="desktop">
        <ul class="menu__desktop">
          <li class="menu__desktop__item"><a href="about.html">About Us</a></li>
          <li class="menu__desktop__item"><a href="rooms.html">Rooms</a></li>
          <li class="menu__desktop__item"><a href="offers.html">Offers</a></li>
          <li class="menu__desktop__item"><a href="contact.html">Contact</a></li>
        </ul>
      </div>
      <div class="header__user-button"><img src="./img/login_mobile.png" alt="UserLogin"></div>
      <div class="header__search-button"><img src="./img/search_mobile.png" alt="Search"></div>
    </div>
  </header>
  ...
  <footer>
    <div class="footer">
      ...
      <div class="container">
        <div class="footer__logo">
          <img class="footer__logo--image" src="./img/logo_footer_mobile.png" alt="Logo Hotel">
        </div>
        ...
        <div class="footer__socials">
          <img class="footer__socials--image" src="./img/Socials_footer_mobile.png" alt="RRSS">
        </div>
      </div>
          ...
          <div class="group">
            <div class="item">
              <div class="footer__phone__image">
                <img src="./img/phono_footer_mobile.svg" alt="phono icon">
              </div>
            ...
            <div class="item">
              <div class="footer__phone__image">
                <img src="./img/mail_footer_mobile.svg" alt="mail icon">
              </div>
              <div class="footer__phone__number">
                <p>Email</p>
            ...
            <div class="item" id="item3">
              <div class="footer__phone__image">
                <img src="./img/gps_footer_mobile.svg" alt="gps icon">
              </div>
              <div class="footer__phone__number">
                <p>Hotel Address</p>
    ...
    <div class="finish">
      <p class="finish__copyright">Copyright By@Example - 2020</p>
